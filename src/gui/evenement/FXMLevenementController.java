...
public class FXMLevenementController implements Initializable {
    ...
    private void Retour(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("../dashboardadmin/FXMLdashboardadmin.fxml"));
...
//        String s = categorie.getSelectionModel().getSelectedItem().toString();
        ...
        if (nom.getText().equals("")) {
            ...
            showMessageDialog(null, "Nom text vide.");
            nom.requestFocus();

        } else if (myDate == null) {
            showMessageDialog(null, "date debut vide.");
            Datedebut.requestFocus();
        } else if (myDatef == null) {
            showMessageDialog(null, "date  fin vide.");
